...
namespace WebApplication1.Utilities
{
    ...
    public class EmailSender : IEmailSender
    {
        ...
        private readonly string _smtpUser = "YourForgatPassword@gmail.com"; // Gmail adresi
        private readonly string _smtpPass = "Your Gmail App Password"; // Gmail uygulama şifresi
